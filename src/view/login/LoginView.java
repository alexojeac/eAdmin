...
public class LoginView extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        eAdminLabel = new javax.swing.JLabel();
        ...
        background.add(logoLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 80, 290, 150));

        eAdminLabel.setBackground(new java.awt.Color(255, 255, 255));
        eAdminLabel.setFont(new java.awt.Font("Roboto Medium", 1, 36)); // NOI18N
        eAdminLabel.setForeground(new java.awt.Color(255, 255, 255));
        eAdminLabel.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        eAdminLabel.setText("eAdmin");
        background.add(eAdminLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(500, 230, 290, -1));

        cityLabel.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/city.png"))); // NOI18N
        background.add(cityLabel, new org.netbeans.lib.awtextra.AbsoluteConstraints(501, 0, 290, 500));
    ...
    private javax.swing.JLabel eAdminLabel;
